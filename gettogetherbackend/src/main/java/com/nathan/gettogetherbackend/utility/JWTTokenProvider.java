package com.nathan.gettogetherbackend.utility;
...
public class JWTTokenProvider {
    ...
    public HttpHeaders getJwtHeader(UserPrincipal user) {
        ...
        headers.add("Jwt-Token", generateJwtToken(user));
        return headers;
    }

    public String generateJwtToken(UserPrincipal userPrincipal) {
        String[] claims = getClaimsFromUser(userPrincipal);
        return JWT.create().withIssuer("getTogether").withAudience("GetTogether")
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer("Gettogether").build();
